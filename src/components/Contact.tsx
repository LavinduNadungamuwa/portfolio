...
// import { contactAPI } from '../hooks/api';
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-8 bg-gray-50 dark:bg-gray-800 transition-colors duration-300 h-screen flex items-center">
        ...
        <div className="w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 border border-gray-100 dark:border-gray-700">
              ...
              {submitStatus && (
                <div className={`mb-4 p-3 rounded-lg flex items-center gap-3 ${submitStatus.type === 'success'
